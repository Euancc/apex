  ...
  return (
    <div className="about-container" id="about">
      ...
      <p className="about-p">
        ...
        punctuality in delivering exceptional results.
        <br />
        <br />
        Whether you're seeking custom-built creations or projects executed
        flawlessly from existing plans, Apex Built is here to turn your idea
        into reality.
      </p>
    </div>
  )
